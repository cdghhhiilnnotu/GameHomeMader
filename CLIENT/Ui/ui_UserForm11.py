...
################################################################################
## Form generated from reading UI file 'UserFormMiyEzo.ui'
##
...
"padding: 0px")
        icon18 = QIcon()
        icon18.addFile(u":/icons/EC8482/trash-2.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"border-radius: 20px;")
        icon19 = QIcon()
        icon19.addFile(u":/icons/EC8482/git-merge.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        font10.setWeight(50)
        self.descriptionGame.setFont(font10)
...
"padding-left: 7px;")
        ...
        self.idGameText.setFont(font11)
...
"padding-left: 7px;")
        ...
        self.nameGameText.setFont(font11)
...
"padding-left: 7px;")
        ...
        self.priceGameText.setFont(font11)
...
"background-color: rgb(0, 255, 255);")
        ...
        self.cancelBtn.setFont(font13)
        self.cancelBtn.setStyleSheet(u"color: rgb(0, 0, 0);\n"
"background-color: rgb(206, 103, 114);")
        icon22 = QIcon()
        icon22.addFile(u":/icons/EC8482/x-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        font14.setBold(True)
        font14.setWeight(75)
        self.notificationTitle.setFont(font14)
        ...
        icon23 = QIcon()
        icon23.addFile(u":/icons/EC8482/x-octagon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.closeNotificationBtn.setIcon(icon23)
...
"}")
        ...
        font15.setWeight(50)
        self.emailLoginLabel.setFont(font15)
        ...
        self.passwordLoginLabel.setFont(font15)
        ...
        font16.setBold(True)
        font16.setWeight(75)
        self.signUpLabel_2.setFont(font16)
        ...
        font17.setWeight(50)
        self.wrongUserInputLabel.setFont(font17)
...
"}")
        ...
        self.signUpLabel.setFont(font16)
        ...
        font18.setWeight(50)
        self.nameSignUpLabel.setFont(font18)
        ...
        self.emailSignUpLabel.setFont(font18)
        ...
        self.passwordSignUpLabel.setFont(font18)
        ...
        self.repasswordSignUpLabel.setFont(font18)
        ...
        font19.setBold(True)
        font19.setWeight(75)
        self.headerLoginLabel.setFont(font19)
