...
################################################################################
## Form generated from reading UI file 'UserFormfERQRw.ui'
##
...
"border-radius: 20px;")
        icon15 = QIcon()
        icon15.addFile(u":/icons/EC8482/chevrons-right.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.home_more_game_btn.setIcon(icon15)
...
"background-color: rgb(0, 255, 255);\n"
"border-radius: 20px;")
        self.library_more_game_btn.setIcon(icon15)
...
"padding: 0px")
        icon16 = QIcon()
        icon16.addFile(u":/icons/EC8482/trash-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.deleteOrder_1.setIcon(icon16)
...
"padding: 0px")
        self.deleteOrder_2.setIcon(icon16)
...
"padding: 0px")
        self.deleteOrder_3.setIcon(icon16)
...
"padding: 0px")
        self.deleteOrder_5.setIcon(icon16)
...
"padding: 0px")
        self.deleteOrder_4.setIcon(icon16)
...
"padding: 0px")
        self.deleteOrder_7.setIcon(icon16)
...
"padding: 0px")
        self.deleteOrder_8.setIcon(icon16)
...
"padding: 0px")
        self.deleteOrder_9.setIcon(icon16)
...
"padding: 0px")
        self.deleteOrder_6.setIcon(icon16)
...
"border-radius: 20px;")
        icon17 = QIcon()
        icon17.addFile(u":/icons/EC8482/dollar-sign.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.payBtn.setIcon(icon17)
...
"}")
        icon18 = QIcon()
        icon18.addFile(u":/icons/EC8482/airplay.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.PlayBuyBtn.setIcon(icon18)
...
"background-color: rgb(0, 255, 255);")
        icon19 = QIcon()
        icon19.addFile(u":/icons/EC8482/check-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.doneBtn.setIcon(icon19)
...
"background-color: rgb(206, 103, 114);")
        icon20 = QIcon()
        icon20.addFile(u":/icons/EC8482/x-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.cancelBtn.setIcon(icon20)
