...
################################################################################
## Form generated from reading UI file 'UserFormyPZdHE.ui'
##
...
"background-color: rgb(206, 103, 114);")
    ...
    def retranslateUi(self, MainWindow):
...
#if QT_CONFIG(tooltip)
        self.libraryBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Data Analysis", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.home_search_label.setText(QCoreApplication.translate("MainWindow", u"T\u00ecm ki\u1ebfm:", None))
        self.home_search_btn.setText(QCoreApplication.translate("MainWindow", u" Search", None))
        ...
        self.library_search_label.setText(QCoreApplication.translate("MainWindow", u"T\u00ecm ki\u1ebfm:", None))
        self.library_search_btn.setText(QCoreApplication.translate("MainWindow", u" Search", None))
        ...
        self.nameGameOrder_1.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.avtGameOrder_1.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.deleteOrder_1.setText("")
        self.nameGameOrder_2.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.avtGameOrder_2.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        ...
        self.nameGameOrder_8.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.avtGameOrder_8.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.deleteOrder_8.setText("")
        self.nameGameOrder_9.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.avtGameOrder_9.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.deleteOrder_9.setText("")
        self.nameGameOrder_6.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.avtGameOrder_6.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.deleteOrder_6.setText("")
        self.payMethodBox.setItemText(0, QCoreApplication.translate("MainWindow", u"Cash", None))
        self.payMethodBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Credit card", None))
        self.payMethodBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Visa", None))
        self.payMethodBox.setItemText(3, QCoreApplication.translate("MainWindow", u"Paypal", None))

        self.payBtn.setText("")
        self.totalCost.setText(QCoreApplication.translate("MainWindow", u"0", None))
